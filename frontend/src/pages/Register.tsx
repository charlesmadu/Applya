      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-700 via-purple-800 to-indigo-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold text-white mb-6 leading-tight">
            Start your organized<br />job search today.
          </h1>
          <p className="text-purple-100 text-lg mb-8">
            Create your free account and take control of your career journey.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-purple-100">Track unlimited applications</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <Check size={16} className="text-white" />
              </div>
              <span className="text-purple-100">AI-powered CV optimization</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <Check size={16} className="text-white" />
              </div>
              <span className="text-purple-100">Smart reminders & insights</span>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500">Start tracking your job applications for free</p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all ${
                      errors.firstName ? 'border-red-300 bg-red-50' : 'border-slate-300 bg-white'
                    }`}
                  />
                </div>
                {errors.firstName && (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Doe"
                  className={`w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all ${
                    errors.lastName ? 'border-red-300 bg-red-50' : 'border-slate-300 bg-white'
                  }`}
                />
                {errors.lastName && (
              ...
              {formData.password && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-slate-500">
                    Strength: <span className={`font-medium ${passwordStrength >= 3 ? 'text-green-600' : passwordStrength >= 2 ? 'text-yellow-600' : 'text-red-600'}`}>
                ...
                <div className="grid grid-cols-2 gap-1">
                  {passwordRequirements.map((req, i) => (
                    <div key={i} className="flex items-center gap-1.5">
                      <Check size={12} className={req.met ? 'text-green-600' : 'text-slate-300'} />
                      <span className={`text-xs ${req.met ? 'text-green-600' : 'text-slate-400'}`}>{req.text}</span>
                    </div>
                  ))}
                </div>
              </div>
